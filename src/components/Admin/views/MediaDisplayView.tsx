        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/90 shadow-md space-y-5">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="font-extrabold text-slate-900 text-base">Tampilan Dashboard TV Monitor</h2>
            ...
            >
              ...
              <span>{saveSuccess ? 'Tersimpan!' : 'Simpan Pengaturan Display'}</span>
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              ...
              >
                ...
                <span>{saveSuccess ? 'Berhasil Disimpan!' : 'Simpan Semua Pengaturan Display'}</span>
              </button>
            </div>
          </div>
        </div>
